   ...
   <body class="easyui-layout">
  	...
  	<div id="div_config" region="center" title="功能菜单信息" class="easyui-panel bgColor" style="overflow: auto;">
		<table class="tablestyle01" style="margin-top:5px;" width="100%">
			...
			<tr>
				<td>排序序号：</td>
				<td><input name="tree.pxXh" id="inp_pxXh" class="easyui-validatebox" required="true" validType="number" maxlength="3" style="width: 50px;" /></td>
			</tr>
			<tr>
				<td>菜单名称：</td>
			...
			<!-- <tr>
				...
				<td>
					<select name="tree.openMethod">
						<option value="tab">单个tab页</option>
