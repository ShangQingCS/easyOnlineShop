...
<html>
	<head>
		...
		var formatterUserGrade = function(value,rec) {
			if(value=="0") {
		...
		var formatterLevel = function(value,rec) {
			return "<span style='color: green;'>Level"+value+"</span>";
		}
