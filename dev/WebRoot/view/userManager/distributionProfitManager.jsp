	...
	<head>
		...
		var operateFlag = function() {
            ...
            if(list==null){
            	...
            	var yjf = $("#userFxBalance").val() ;//分销金额
            	var ejf = $("#_userFxBalance").val() ;//编辑分销金额
                if(list==0){//增加
                	//alert("增加");
		...
		var queryUserPurse = function (){
			...
			$.ajax({
				url: "${basePath }/view/userManager/userPurse!queryUserPurseFX.action",
				cache: false,
				dataType:"json",
				success: function(json){
					//do nothing
 	...
 	<body class="easyui-layout">
	  	<div id="header" region="north" class="easyui-panel bgColor" collapsible="false" title="分销收益管理" style="height:100px; width:100%">
	  	...
	  	<div id="content" region="center" style="width: 100%;display: none;" ><!--  -->
	  		<form id="ff" method="post" enctype="multipart/form-data">
	  			<table id="userinfo_table" border="0" dataType="text" class="tablestyle01" style="width:100%">
	  				<tr>
	  					<td>
	  						<input type="hidden" id="purse_type" name="purse_type" value = "1" /><!-- 三级分销 -->
	  					...
	  					<td>
	  						...
	  						收益金额:<input type="text" id="_userFxBalance" name="_balance" />
	  					</td>
	  				</tr>
	  				<tr>
	  					<td>
		...
		<div id="footer" region="center" style="width: 100%;margin-top: 300px" >
			<table id="tab_list" rownumbers="true" region="center" fitColumns="true" class="easyui-datagrid" 
		    	url="userPurse!queryUserPurseFX.action" style="width:auto;height:auto;padding-top: 500px;" title="" 
				...
				<thead>
					<tr>
						...
						<th field="tradeAmount" width="20%">分销收益</th>
