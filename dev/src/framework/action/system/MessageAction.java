...
public class MessageAction extends FenyeBase{
	...
	public String messageCount(){
		...
		List<Map> list = DBUtil.getDBUtilByRequest().queryBySQL(sql, RequestHelper.getUser().getUId());
		try {
	...
	public String info(){
		...
		DBUtil.getDBUtilByRequest().update(message);
		return "json";
	}
	
	public String delete(){
		initMessage();
		DBUtil.getDBUtilByRequest().delete(this.message);
		return "json";
	}
