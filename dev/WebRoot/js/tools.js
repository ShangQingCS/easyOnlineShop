...
var _html = "<div id='loading' style='position:absolute;left:0;width:100%;height:"
		...
		+ leftW
		+ "px;top:200px;width:auto;height:16px;padding:12px 5px 10px 30px;\ background:#fff url(/dev/js/jquery-easyui-1.4/themes/gray/images/loading.gif) no-repeat scroll 5px 10px;border:2px solid #ccc;color:#000;'>\ 正在加载，请等待...\ </div></div>";
