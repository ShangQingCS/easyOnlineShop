	...
	<head>
		...
		var operateFlag = function() {
            ...
            if(list==null){
            	...
            	var yjf = $("#userJfBalance").val() ;//可用
            	var ejf = $("#_userJfBalance").val() ;//编辑积分
                if(list==0){//增加
                	//alert("增加");
		...
		var queryUserPurse = function (){
			...
			/**/
			$.ajax({
				url: "${basePath }/view/userManager/userPurse!queryUserPurseJF.action",
				cache: false,
				dataType:"json",
				success: function(json){
					//do nothing
 	...
 	<body class="easyui-layout">
	  	...
	  	<div id="content" region="center" style="width: 100%;display: none;" ><!--  -->
	  		<form id="ff" method="post" enctype="multipart/form-data">
	  			<table id="userinfo_table" border="0" dataType="text" class="tablestyle01" style="width:100%">
	  				<tr>
	  					<td>
	  						<input type="hidden" id="purse_type" name="purse_type" value = "2" /><!-- 积分 -->
	  					...
	  					<td>
	  						...
	  						会员积分:<input type="text" id="_userJfBalance" name="_balance" />
	  					</td>
	  				</tr>
	  				<tr>
	  					<td>
		...
		<div id="footer" region="center" style="width: 100%;margin-top: 300px" >
			<table id="tab_list" rownumbers="true" region="center" fitColumns="true" class="easyui-datagrid" 
		    	url="userPurse!queryUserPurseJF.action" style="width:auto;height:auto;padding-top: 500px;" title="" 
				...
				<thead>
					<tr>
						...
						<th field="tradeAmount" width="20%">积分</th>
